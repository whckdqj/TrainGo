...
<div class="page-main-style">
	<form:form action="infowrite.do" commandName="infoBoardCommandId" cssClass="form-horizontal" enctype="multipart/form-data" id="write_form" method="post">
	<legend>Information</legend>
	<c:if test="${infoBoardCommandId.code==1}"><h4>Food Information</h4></c:if>
	<c:if test="${infoBoardCommandId.code==2}"><h4>Festival Information</h4></c:if>
	<c:if test="${infoBoardCommandId.code==3}"><h4>Sightseeing Information</h4></c:if>
	<input type="hidden" name="id" value="${userId}">
		<div class="form-group">
		<c:if test="${infoBoardCommandId.code==1}">
			<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=1'">Food Information</button>
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=2'">Festival Information</button>
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=3'">Sightseeing Information</button>
		</c:if>
		<c:if test="${infoBoardCommandId.code==2}">
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=1'">Food Information</button>
			<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=2'">Festival Information</button>
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=3'">Sightseeing Information</button>
		</c:if>
		<c:if test="${infoBoardCommandId.code==3}">
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=1'">Food Information</button>
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infowrite.do?code=2'">Festival Information</button>
			...
			<div class="col-xs-10 col-xs-offset-2">
                <div class="btn-group btn-group-justified" role="group">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-danger" onclick="location.href='${pageContext.request.contextPath}/board/informationBoard/infolist.do?code=${infoBoardCommandId.code}'">게시판</button>
                    </div>
                    <div class="btn-group" role="group">
